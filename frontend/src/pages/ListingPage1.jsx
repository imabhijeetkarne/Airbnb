...
function ListingPage1() {
  ...
  const availableAmenities = [
    ...
    "Free Parking", "Washing Machine", "Gym", "Pool"
  ];
  ...
  return (
    <div className='w-[100%] h-[100vh] bg-white flex items-center justify-center relative overflow-auto'>
      ...
      <form action="" className='max-w-[900px] w-[90%] h-[550px] flex items-center justify-start flex-col md:items-start gap-[10px] overflow-auto mt-[50px]' onSubmit={(e) => {
        ...
        <div className='w-[90%] flex items-start justify-start flex-col gap-[10px] mb-4'>
          <label className='text-[20px] mb-2'>Amenities</label>
          <div className='flex flex-wrap gap-3 w-[90%]'>
            {availableAmenities.map((amenity) => (
              ...
              >
                {amenities.includes(amenity) && <FaCheck />}
                {amenity}
              </div>
            ))}
          </div>
